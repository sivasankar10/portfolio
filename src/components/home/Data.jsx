...
const Data = ( ) => {
    ...
    <div className="home__data">
        <h1 className="home__title">Siva Sankar
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
       ...
       <p className="home__description">I'm someone who gets pretty excited about new tech stuff. Always keen to learn and figure out how to use the latest gadgets and innovations. I love staying ahead of the game and using new tech to come up with cool ideas and 
       solutions</p>
